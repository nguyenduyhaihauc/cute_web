...
const messages = [
    "Gửi đến những người con gái tuyệt vời nhất trong nhóm mình.",
    "Chúc các bạn luôn xinh đẹp, rạng rỡ và hạnh phúc trong ngày đặc biệt này.",
    "Mong rằng mỗi ngày trôi qua, các bạn sẽ luôn nhận được niềm vui và những điều tốt đẹp nhất.",
    "Chúc các bạn luôn mạnh mẽ, tự tin và thành công trong mọi việc.",
    "Hôm nay là ngày của các bạn, hãy tận hưởng thật vui vẻ và luôn yêu thương bản thân mình nhé.",
    "Chúc mừng Ngày Phụ nữ Việt Nam! Các bạn xứng đáng có được tất cả hạnh phúc trên thế giới này."
];
